...
export const RESULT = {
  ...
  CANNOT_FIND_PASS_GROUP: $_$(119, 404, 'CANNOT_FIND_PASS_GROUP'),
  CANNOT_FIND_PASS: $_$(120, 404, 'CANNOT_FIND_PASS'),
  PASS_PROGRAM_HAS_USING: $_$(121, 500, 'PASS_PROGRAM_HAS_USING'),
  PASS_PROGRAM_IS_NOT_SALE: $_$(122, 500, 'PASS_IS_NOT_SALE'),
  PASS_PROGRAM_DISALLOWED_RENEW: $_$(123, 500, 'PASS_PROGRAM_DISALLOWED_RENEW'),
  CANNOT_FIND_NOTIFICATION: $_$(124, 404, 'CANNOT_FIND_NOTIFICATION'),
  INVALID_REFERRAL_CODE: $_$(125, 404, 'INVALID_REFERRAL_CODE'),
  ALREADY_SELECTED_REFERRER: $_$(126, 409, 'ALREADY_SELECTED_REFERRER'),
  CANNOT_REFERRAL_MYSELF: $_$(127, 400, 'CANNOT_REFERRAL_MYSELF'),
};
